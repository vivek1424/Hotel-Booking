...
const ImagesSection = () => {
  ...
  const handleDelete = (
    ...
    //default event is to submit the form, we dont want to submit 
    event.preventDefault();
    //returning the array which returns values except those which are deleted 
    ...
    <div>
      ...
      <div className="border rounded p-4 flex flex-col gap-4">
        ...
        <input type="file"
          ...
          {...register("imageFiles", {
            validate: (imageFiles) => {
              //existingImageUrl length will be useful during the edit of the hotel 
