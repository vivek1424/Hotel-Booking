...
const Register = () => {
    //will be used when succesfully registered to navigate to homepage 
    ...
    return (
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                <input
                    type="password"
                    className="border rounded w-full py-1 px-2 font-normal" {...register("password", { required: "This field is required", minLength: { value: 6, message: "Password must be at least 6 characters" } })} />
                {
                    errors.password && (
