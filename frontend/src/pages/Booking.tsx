...
const Booking = () => {
    ...
    useEffect(() => {
        if (search.checkIn && search.checkOut) {
            const nights: number = Math.abs(search.checkOut.getTime() - search.checkIn.getTime()) / (1000 * 60 * 60 * 24)
    ...
    return (
        <div className='grid md:grid-cols-[1fr_2fr]'>
            <BookingDetailsSummary checkIn={search.checkIn} checkOut={search.checkOut}
